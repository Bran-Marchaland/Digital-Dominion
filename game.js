...
class partie_1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.shieldV = this.add.sprite(2000, 1100, 'powerUP').setScale(2.5).setScrollFactor(0);
        ...
        this.anims.create({
            key: 'shieldReady',
            frames: this.anims.generateFrameNumbers('powerU', { start: 0, end: 0 }),
            frameRate: 4,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'shieldUse',
            frames: this.anims.generateFrameNumbers('powerU', { start: 1, end: 1 }),
            frameRate: 4,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'shieldReloading',
            frames: this.anims.generateFrameNumbers('powerU', { start: 2, end: 2 }),
            frameRate: 4,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'jumpReady',
            frames: this.anims.generateFrameNumbers('powerU', { start: 3, end: 3 }),
            frameRate: 4,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'jumpUse',
            frames: this.anims.generateFrameNumbers('powerU', { start: 4, end: 4 }),
            frameRate: 4,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'jumpReload',
            frames: this.anims.generateFrameNumbers('powerU', { start: 5, end: 5 }),
            frameRate: 4,
            repeat: -1
        });
    ...
    if(HP ==  0){
        ...
        if (rechargeB == 0) {
            this.shieldV.anims.play("shieldReady", true);
        }
        if (rechargeB == 1) {
            this.shieldV.anims.play("shieldUse", true);
        }
        if (rechargeB == 2) {
...
class partie_2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.porte_1 = this.physics.add.image(17.7 * 64, 38 * 64, 'porteS1')
            .setImmovable(true)
        this.porte_1.body.setAllowGravity(false);
        this.physics.add.collider(this.porte_1, this.player);
        ...
        this.anims.create({
            key: 'shieldUse',
            frames: this.anims.generateFrameNumbers('powerUP', { start: 1, end: 1 }),
            frameRate: 4,
            repeat: -1
        })
        ...
        this.anims.create({
            key: 'shieldReloading',
            frames: this.anims.generateFrameNumbers('powerUP', { start: 2, end: 2 }),
            frameRate: 4,
            repeat: -1
        })
        ...
        this.anims.create({
            key: 'jumpReady',
            frames: this.anims.generateFrameNumbers('powerUP', { start: 3, end: 3 }),
            frameRate: 4,
            repeat: -1
        })
        ...
        this.anims.create({
            key: 'jumpUse',
            frames: this.anims.generateFrameNumbers('powerUP', { start: 4, end: 4 }),
            frameRate: 4,
            repeat: -1
        })
        ...
        this.anims.create({
            key: 'jumpReloading',
            frames: this.anims.generateFrameNumbers('powerUP', { start: 5, end: 5 }),
            frameRate: 4,
            repeat: -1
        })
...
class partie_3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.tir_player = this.physics.add.group({ gravity: false })
        this.cameras.main.centerOn(this.player.x, this.player.y)
        this.jumpV = this.add.sprite(2400, 1100, 'powerUP').setScale(2.5).setScrollFactor(0);
        this.shieldV = this.add.sprite(2000, 1100, 'powerUP').setScale(2.5).setScrollFactor(0);
        this.surchauffeV = this.add.sprite(-1650, 1000, 'surchauffe').setScale(12.8).setScrollFactor(0);
        this.surchauffeV.depth = 1000
        this.vie.depth = 1000
        ...
        /////////////////////////////////TP\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        this.tp = this.physics.add.group({ allowGravity: false, });
        this.tp1 = this.physics.add.image(11 * 64, 6 * 64, 'TP1');
        this.tp.add(this.tp1)
        this.physics.add.overlap(this.player, this.tp1, this.phase4, null, this);
    ...
    update() {
        ...
        if (rechargeJ == 0) {
            this.jumpV.anims.play("jumpReady", true);
        }
        if (rechargeJ == 1) {
            this.jumpV.anims.play("jumpUse", true);
        }
        if (rechargeJ == 2) {
...
class partie_4 extends Phaser.Scene {
    ...
    create() {
        ...
        /////////////////////////////////TP\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        this.tp = this.physics.add.group({ allowGravity: false, });
        this.tp1 = this.physics.add.image(17 * 64, 45 * 64, 'TP1');
        this.tp.add(this.tp1)
        this.physics.add.overlap(this.player, this.tp1, this.phase5, null, this);
...
class partie_5 extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.collider(this.player, base3);
        this.cameras.main.zoom = 0.2;
        //this.cameras.main.startFollow(this.player);
        this.clavier = this.input.keyboard.addKeys('Q,D,S,E,R,X,F,SPACE,SHIFT');
        this.vie = this.add.sprite(-800, -600, 'HP').setScale(1.8).setScrollFactor(0);
        ...
        this.heal = this.physics.add.group()
        this.heal.create(30 * 64, 54.5 * 64, 'heal').setScale(1.5);
        this.heal.create(113 * 64, 66.5 * 64, 'heal').setScale(1.5);
        this.heal.create(34 * 64, 105.5 * 64, 'heal').setScale(1.5);
        this.heal.create(105 * 64, 132.5 * 64, 'heal').setScale(1.5);
        ...
        this.tourelle = this.physics.add.group({ immovable: true, allowGravity: false });
        this.tourelle.create(5 * 64, 38.5 * 64, 'tourelle');         //0
        this.tourelle.create(8 * 64, 51.5 * 64, 'tourelle');         //1
        this.tourelle.create(8 * 64, 53.5 * 64, 'tourelle');         //2
        this.tourelle.create(28 * 64, 64.5 * 64, 'tourelle');         //3
        this.tourelle.create(56 * 64, 62.5 * 64, 'tourelle');         //4
        this.tourelle.create(46 * 64, 53.5 * 64, 'tourelle');         //5
        this.tourelle.create(63 * 64, 42.5 * 64, 'tourelle');         //6
        this.tourelle.create(69 * 64, 42.5 * 64, 'tourelle');         //7
        this.tourelle.create(75 * 64, 42.5 * 64, 'tourelle');         //8
        this.tourelle.create(81 * 64, 42.5 * 64, 'tourelle');         //9
        this.tourelle.create(87 * 64, 42.5 * 64, 'tourelle');         //10
        this.tourelle.create(93 * 64, 42.5 * 64, 'tourelle');         //11
        this.tourelle.create(108 * 64, 42.5 * 64, 'tourelle');         //12
        this.tourelle.create(123 * 64, 49.5 * 64, 'tourelle');         //13
        this.tourelle.create(140 * 64, 42.5 * 64, 'tourelle');         //14
        this.tourelle.create(92 * 64, 59.5 * 64, 'tourelle');         //15
        this.tourelle.create(123 * 64, 52.5 * 64, 'tourelle');         //16
        this.tourelle.create(20 * 64, 87.5 * 64, 'tourelle');         //17
        this.tourelle.create(33 * 64, 87.5 * 64, 'tourelle');         //18
        this.tourelle.create(50 * 64, 87.5 * 64, 'tourelle');         //19
        this.tourelle.create(90 * 64, 88.5 * 64, 'tourelle');         //20
        this.tourelle.create(100 * 64, 99.5 * 64, 'tourelle');         //21
        this.tourelle.create(110 * 64, 88.5 * 64, 'tourelle');         //22
        this.tourelle.create(57 * 64, 95.5 * 64, 'tourelle');         //23
        this.tourelle.create(64 * 64, 95.5 * 64, 'tourelle');         //24
        this.tourelle.create(57 * 64, 112.5 * 64, 'tourelle');         //25
        this.tourelle.create(66 * 64, 112.5 * 64, 'tourelle');         //26
        this.tourelle.create(74 * 64, 112.5 * 64, 'tourelle');         //27
        this.tourelle.create(84 * 64, 119.5 * 64, 'tourelle');         //28
        this.tourelle.create(93 * 64, 119.5 * 64, 'tourelle');         //29
        this.tourelle.create(85 * 64, 121.5 * 64, 'tourelle');         //30
        this.tourelle.create(92 * 64, 121.5 * 64, 'tourelle');         //31
        this.tourelle.create(21 * 64, 121.5 * 64, 'tourelle');         //32
        this.tourelle.create(21 * 64, 123.5 * 64, 'tourelle');         //33
        this.tourelle.create(35 * 64, 121.5 * 64, 'tourelle');         //34
        this.tourelle.create(35 * 64, 123.5 * 64, 'tourelle');         //35
        this.tourelle.create(42 * 64, 132.5 * 64, 'tourelle');         //36
        this.tourelle.create(61 * 64, 132.5 * 64, 'tourelle');         //37
        this.tourelle.create(46 * 64, 134.5 * 64, 'tourelle');         //38
        this.tourelle.create(57 * 64, 134.5 * 64, 'tourelle');         //39
        this.tourelle.create(97 * 64, 134.5 * 64, 'tourelle');         //40
        this.tourelle.create(97 * 64, 137.5 * 64, 'tourelle');         //41
        ...
        this.tourelle.getChildren()[38].vieTourelle = 4;
        this.tourelle.getChildren()[38].canshoot = true;
        this.tourelle.getChildren()[39].vieTourelle = 4;
        this.tourelle.getChildren()[39].canshoot = true;
        this.tourelle.getChildren()[30].vieTourelle = 4;
        this.tourelle.getChildren()[40].canshoot = true;
        this.tourelle.getChildren()[41].vieTourelle = 4;
        this.tourelle.getChildren()[41].canshoot = true;
        /////////////////////////////////GENERATEUR\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\

        this.generateur_1 = this.physics.add.image(122 * 64, 61 * 64, 'generateur')
            .setImmovable(true)
        this.generateur_1.depth = 1
        this.generateur_1.body.setAllowGravity(false);
        this.physics.add.collider(this.generateur_1, this.player);
        ...
        this.generateur_2 = this.physics.add.image(106 * 64, 95.5 * 64, 'generateur')
            .setImmovable(true)
        this.generateur_2.depth = 1
        this.generateur_2.body.setAllowGravity(false);
        this.physics.add.collider(this.generateur_2, this.player);
        ...
        this.generateur_3 = this.physics.add.image(27 * 64, 101.5 * 64, 'generateur')
            .setImmovable(true)
        this.generateur_3.depth = 1
        this.generateur_3.body.setAllowGravity(false);
        this.physics.add.collider(this.generateur_3, this.player);
        ...
        this.generateur_4 = this.physics.add.image(68 * 64, 106.5 * 64, 'generateur')
            .setImmovable(true)
        this.generateur_4.depth = 1
        this.generateur_4.body.setAllowGravity(false);
        this.physics.add.collider(this.generateur_4, this.player);
        ...
        /////////////////////////////////PORTE\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        this.porte_1 = this.physics.add.image(86 * 64, 56 * 64, 'porteS2')
            .setImmovable(true)
        this.porte_1.body.setAllowGravity(false);
        this.physics.add.collider(this.porte_1, this.player);

        this.porte_2 = this.physics.add.image(98 * 64, 143 * 64, 'porteS2')
            .setImmovable(true)
        this.porte_2.body.setAllowGravity(false);
        this.physics.add.collider(this.porte_2, this.player);
        ...
        /////////////////////////////////MI\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        this.MI_1 = this.physics.add.image(135 * 64, 142.5 * 64, 'MI')
            .setImmovable(true)
        this.MI_1.body.setAllowGravity(false);
        this.physics.add.collider(this.MI_1, this.player);
        ...
        /////////////////////////////////ASCENSEUR\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        this.ascenseur_1 = this.physics.add.image(130 * 64, 147.5 * 64, 'ascensseur')
            .setImmovable(true)
        this.ascenseur_1.body.setAllowGravity(false);
        this.physics.add.collider(this.ascenseur_1, this.player);
        ...
        /////////////////////////////////COLISION\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        this.physics.add.collider(this.tourelle, base3);

        this.physics.add.collider(this.projectile_tourelle, base3, this.destroylaser, null, this)
        this.physics.add.collider(this.projectile_tourelle, this.player, this.toucheplayer, null, this)
        this.physics.add.collider(this.tir_player, base3, this.destroylaser, null, this)
        this.physics.add.collider(this.tir_player, this.generateur_1, this.DG, null, this)
        this.physics.add.collider(this.tir_player, this.generateur_2, this.DG, null, this)
        this.physics.add.collider(this.tir_player, this.generateur_3, this.DG, null, this)
        this.physics.add.collider(this.tir_player, this.generateur_4, this.DG, null, this)
        this.physics.add.collider(this.tir_player, this.generateur_5, this.DG, null, this)
        this.physics.add.collider(this.tir_player, this.generateur_6, this.DG, null, this)
        this.physics.add.collider(this.heal, base3, this.DG, null, this)
        this.physics.add.collider(this.player, this.tp, this.P2, null, this);
    ...
    update() {
        ...
        if (this.tourelle.getChildren()[5]) {
            const distance6 = Phaser.Math.Distance.Between(this.tourelle.getChildren()[5].x, this.tourelle.getChildren()[4].y, this.player.x, this.player.y);
            if (distance6 < 3000) {
                if (this.tourelle.getChildren()[5].canshoot == true) {
                    this.projectile_tourelle.create(this.tourelle.getChildren()[5].x, this.tourelle.getChildren()[5].y, "lazzzzzer").setVelocityX(this.player.x - this.tourelle.getChildren()[5].x).setVelocityY(this.player.y - this.tourelle.getChildren()[5].y).body.setAllowGravity(false)
                    this.tourelle.getChildren()[5].canshoot = false
        ...
        if (this.tourelle.getChildren()[39]) {
            const distance40 = Phaser.Math.Distance.Between(this.tourelle.getChildren()[39].x, this.tourelle.getChildren()[39].y, this.player.x, this.player.y);
            if (distance40 < 3000) {
                if (this.tourelle.getChildren()[39].canshoot == true) {
        ...
        if (this.tourelle.getChildren()[40]) {
            const distance41 = Phaser.Math.Distance.Between(this.tourelle.getChildren()[40].x, this.tourelle.getChildren()[40].y, this.player.x, this.player.y);
            if (distance41 < 3000) {
                if (this.tourelle.getChildren()[40].canshoot == true) {
        ...
        if (this.tourelle.getChildren()[41]) {
            const distance42 = Phaser.Math.Distance.Between(this.tourelle.getChildren()[41].x, this.tourelle.getChildren()[41].y, this.player.x, this.player.y);
            if (distance42 < 3000) {
                if (this.tourelle.getChildren()[41].canshoot == true) {
